...
/** @type {string} */
const CACHE_VERSION = '1751201017|17407973961';
/** @type {string} */
const CACHE_PREFIX = 'Go Race: REDUX-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = '4demo.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["4demo.html","4demo.js","4demo.offline.html","4demo.icon.png","4demo.apple-touch-icon.png","4demo.audio.worklet.js","4demo.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["4demo.wasm","4demo.pck"];
